<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="BrandPages.aspx.vb" Inherits="WebFormBSIGeneralAffairCosmetic.BrandPages" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">List Of Brands</h1>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <hr />
                        <asp:GridView ID="gvBrands" CssClass="table table-hover" ItemType="BSIGeneralAffairBLL.DTO.Brand.BrandDTO"
                            SelectMethod="GetAll" UpdateMethod="Update" DeleteMethod="Delete"
                            DataKeyNames="BrandID,BrandName" runat="server" AutoGenerateColumns="False">
                            <Columns>
                                <asp:TemplateField HeaderText="Brand">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBrandName" runat="server" Text='<%# Item.BrandName %>' />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtBrandName" runat="server" Text='<%# BindItem.BrandName %>' />
                                    </EditItemTemplate>
                                </asp:TemplateField>
