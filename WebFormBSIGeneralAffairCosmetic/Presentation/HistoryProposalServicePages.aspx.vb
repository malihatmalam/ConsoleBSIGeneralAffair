...
Public Class HistoryProposalServicePages
...
#Region "Initiate"
    Sub InitiateButtonNavigation()
        ...
        ViewState("RecordCount") = _proposalBLL.GetCount("Service", txtSearch.Text)
...
#End Region
    ...
    Public Function GetAll(<Control("txtSearch")> name As String) As List(Of ProposalDTO)
        ...
        Return _proposalBLL.GetHistoryProposal("Service", CInt(ViewState("PageNumber")), CInt(ViewState("PageSize")), name)
    End Function
